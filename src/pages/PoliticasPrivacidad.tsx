...
const PoliticasPrivacidad = () => {
  return (
    <LegalPageLayout title="Políticas de Privacidad">
      <p>
      ...
      <h2 className="text-2xl font-bold text-primary mt-10 mb-4">Datos personales requeridos</h2>
      ...
      <h2 className="text-2xl font-bold text-primary mt-10 mb-4">Derechos ARCO</h2>
