...
export function LoanOnboardingModal({ open, onOpenChange }: LoanOnboardingModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl md:max-w-3xl max-w-[calc(100%-2rem)] p-4 sm:p-6 md:p-8 flex flex-col items-center gap-4 sm:gap-6 max-h-[90vh] overflow-y-auto rounded-2xl">
